...
let result1 = await washing_3();  // wait karo jab tak washing function completely exicute nahi ho jata or await hamne isliye lgaya hai kiyun ke ye function foran exicute nahi hoga ye thora time lega or jab tak time lega tab tak koi dosra function exicute nahi hony dega... 
console.log(result1);

let result2 = await soaking_3();  // wait karo jab tak soaking function completely exicute nahi ho jata.
console.log(result2);

let result3 = await drying_3();   // wait karo jab tak drying function completely exicute nahi ho jata.
console.log(result3);
