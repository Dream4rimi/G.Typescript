...
// Enlish
// A syntax error is a mistake in the code that violates the rules of the programming language, preventing the code
// from being properly parsed or executed. These errors occur when the programmer writes code that the compiler or 
