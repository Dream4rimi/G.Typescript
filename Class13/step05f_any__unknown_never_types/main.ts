...
let val1: unknown = val;  // Accepted
let val2: any = val;      // Accepted
let val3: boolean = val;  // Error aega
let val4: number = val;   // Error aega
let val5: string = val;   // Error aega
let val6: Record<string, any> = val;  // Error aega
let val7: any[] = val;    // Error aega
let val8: (...arg: any[]) => void = val;  // Error aega
